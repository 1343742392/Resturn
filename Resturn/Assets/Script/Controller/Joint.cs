...
public class Joint : MonoBehaviour
{
    ...
    [SerializeField]public Transform obj = null;
...
/*    [SerializeField] bool freezeRotX = false;
    ...
    void Start()
    {
        ...
        //transform.rotation = Quaternion.RotateTowards(transform.rotation, obj.transform.rotation,1);
    }
    private void Update()
    {
        //Debug.Log("fixed");
        ...
        var targetPos = obj.position + (new Vector3(objF.x, 0f, objF.z) * 0.1f);
